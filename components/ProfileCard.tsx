    ...
    <div className="container flex justify-center pt-24 pb-6">
      <div className="bg-white shadow-xl w-5/6 md:w-4/6 lg:w-3/6 xl:w-2/6">
        <div className="flex justify-center">
          <div className="rounded-full -mt-20 w-36 h-36 shadow-2xl border-4 border-white bg-white">
        ...
        <div className="mt-8">
          ...
          <div className="mt-1">
            <p className="text-center text-gray-400 font-medium">Engineer</p>
          </div>
          <div className="mt-3">
            <p className="text-sky-50 block text-center font-medium leading-6 px-6 py-3 bg-sky-600">
